...
<article class="node-<?php print $node->nid; ?> <?php print $classes; ?> clearfix"<?php print $attributes; ?>>
  ...
  <?php if (!$page): ?>
    <h2<?php print $title_attributes; ?>>
      <a href="<?php print $node_url; ?>"><?php print $title; ?> - <?php print render($content['field_review_date']); ?></a>
    </h2>
  <?php endif; ?>
  ...
  hide($content['links']);
  hide($content['body']);
  hide($content['field_review_rating']);

  ?>
<br />
  <?php print render($content); ?>

  <p class="latest"><?php print render($content['body']); ?></p>

  <ul class="group-review-links-teaser">
